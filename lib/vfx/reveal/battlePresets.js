...
export const BOLT = {
  ...
  /**
   * 1.00s end to end. The arcs re-strike 18 times a second on their own, so
   * even this window carries roughly eighteen distinct shapes — the crackle
   * comes from the shader, not from how long the envelope is held open.
   */
  travel: 0.12,
  hold: 0.58,
  fade: 0.30,
