...
export function applyArcSettings(palette, scale = 1) {
  ...
  //
  // Above that floor this is purely how much body the bolt has. At 0.019 it
  // read as a drawn hairline on a large disc; the arcs want enough width to
  // look like something carrying current rather than something inked on.
  t.width = 0.032 * scale;
  ...
  // The white core as a fraction of the ribbon. Widening the ribbon without
  // widening this would have grown the coloured sheath alone and left the same
  // hairline of white down the middle.
  t.coreWidth = 0.8;
  t.coreSharp = 4.2;
  t.glowWidth = 4.2;
  t.glowOpacity = 0.55;
